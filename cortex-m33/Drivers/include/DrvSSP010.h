...
#define SSP_FLASH										0x800 /* For Flash/SPI2AHB */
...
/* Control Register 2 */
#define SSP_FS					  (1<<9)	 /* Control FS */ //legend:0523
...
extern void fLib_I2S_Init(UINT32, UINT32, SSP_MODE_T);
extern void fLib_WriteSSP(UINT32,UINT32);
extern UINT32 fLib_ReadSSP(UINT32 );

extern void fLib_SetSSPFrame(UINT32,UINT32);
extern void fLib_SetSSPFramePolar(UINT32,UINT32);

extern void fLib_SetSSPOPMode(UINT32,UINT32);
extern void fLib_SetSSPDataLen(UINT32,UINT32);
extern void fLib_SetSSPpaddingDataLen(UINT32,UINT32);
extern void fLib_SetSSPClkdiv(UINT32,UINT32);

extern void fLib_SSPClearTxFIFO(UINT32 );
extern void fLib_SSPClearRxFIFO(UINT32 );

extern UINT32 fLib_ReadSSPStatus(UINT32 );

extern void fLib_SetSSPSCLKPO(UINT32,UINT32);
extern void fLib_SetSSPSCLKPH(UINT32,UINT32);

extern UINT32 fLib_ReadSSPIntStatus(UINT32 );
extern void fLib_SetSSP_TXFIFO(UINT32,UINT32,UINT32);
extern void fLib_SetSSP_RXFIFO(UINT32,UINT32,UINT32);
extern void fLib_SetSSP_DMA(UINT32,UINT32,UINT32);
extern void fLib_SetSSP_FIFO_Threshold(UINT32,UINT32,UINT32);
extern void fLib_SetSSP_WarmReset(UINT32 );
extern void fLib_SetSSP_ColdReset(UINT32 );
extern UINT32 fLib_ReadSSP32Bit(UINT32 );

extern void fLib_SetSSP_Enable(UINT32,int );
extern void fLib_SetSSP_IntMask(UINT32,int );

extern UINT32 fLib_SSP_GetRxFIFOValidEntries(UINT32 base_addr);
extern UINT32 fLib_SSP_GetTxFIFOValidEntries(UINT32 base_addr);
 
extern void fLib_InitAC97(UINT32);
extern void fLib_AC97_SetSlotValidReg(UINT32,UINT32);
extern int fLib_AC97_ReadRegister(UINT32,UINT32,UINT16*);
extern void fLib_AC97_WriteRegister(UINT32,UINT32,UINT32);
extern void fLib_AC97_WriteData(UINT32,UINT32*,UINT32);
extern void fLib_AC97_ReadData(UINT32,UINT32*,UINT32);
extern UINT32 fLib_AC97_ReadOneWordData(UINT32 );

extern int fLib_AC97_ReadRegisterEx(UINT32,UINT32,UINT16*);
extern void fLib_AC97_WriteRegisterEx(UINT32,UINT32,UINT32);

extern int fLib_ReturnTxFIFO_Count(UINT32 );
extern int fLib_ReturnRxFIFO_Count(UINT32 );
extern UINT32 fLib_SSP_GetTxFIFOLen(UINT32 );
extern void fLib_SetSSP_SDL_Write(UINT32 ,UINT32 ,UINT32);
extern UINT32 fLib_SSP_busy(UINT32 base_addr);
extern void fLib_TXRX_Enable(UINT32 base_address, int tx, int rx);
extern void delay(int ticks);

typedef struct ssp_dma_req_mode{   
	int dma_txreq;
	int dma_rxreq;
	int mode;
} SSP_DMA_REQ_MODE;
