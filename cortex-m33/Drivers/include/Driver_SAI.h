...
typedef struct _ARM_DRIVER_SAI {
  ...
  int32_t              (*Send)            (unsigned int *data, uint32_t num);                  ///< Pointer to \ref ARM_SAI_Send : Start sending data to SAI Interface.
  int32_t              (*Receive)         (unsigned int *data, uint32_t num);                  ///< Pointer to \ref ARM_SAI_Receive : Start receiving data from SAI Interface.
...
#define ARM_DRIVER_SAI_CONTROL_ENABLE 0
#define ARM_DRIVER_SAI_CONTROL_DISABLE 1
